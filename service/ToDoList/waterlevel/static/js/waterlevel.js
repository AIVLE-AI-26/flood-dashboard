document.addEventListener('DOMContentLoaded', function() {
    ...
    var observatories = [
        ...
        { name: '광주광역시(용산교)', x: 520, y: 460, wl: '0.00' },
        { name: '광주광역시(첨단대교)', x: 500, y: 480, wl: '0.00' },
        { name: '광주광역시(유촌교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(풍영정천2교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(어등대교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(신운교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(우제교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(설월교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(벽진동)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(장록교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(평림교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(천교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(용진교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(승용교)', x: 510, y: 490, wl: '0.00' },
        {'name': '광주광역시(극락교)', x: 510, y: 490, wl: '0.00' },
    ];
