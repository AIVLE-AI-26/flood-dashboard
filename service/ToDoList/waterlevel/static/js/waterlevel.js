document.addEventListener('DOMContentLoaded', function () {
  ...
  var observatories = [
    ...
    {
      name: '광주광역시(용산교)',
      lat: 35.2405799574413,
      lng: 126.888496612547,
      wl: '0.00',
      fl: '0',
      홍수주의보: 3.4,
      홍수경보: 3.9,
    ...
    {
      name: '광주광역시(설월교)',
      lat: 35.129444444444445,
      lng: 126.92750000000001,
      wl: '0.00',
      fl: '0',
      홍수주의보: 3.3,
      홍수경보: 3.8,
    ...
    {
      name: '광주광역시(천교)',
      lat: 35.151111111111106,
      lng: 126.90722222222223,
      wl: '0.00',
      fl: '0',
      홍수주의보: 2.9,
      홍수경보: 3.4,
    ...
    {
      name: '광주광역시(용진교)',
      lat: 35.21527777777778,
      lng: 126.74666666666667,
      wl: '0.00',
      fl: '0',
      홍수주의보: 4.3,
      홍수경보: 5.3,
    ...
    {
      name: '광주광역시(승용교)',
      lat: 35.071111111111115,
      lng: 126.77222222222223,
      wl: '0.00',
      fl: '0',
      홍수주의보: 5.6,
      홍수경보: 6.9,
    ...
    {
      name: '광주광역시(극락교)',
      lat: 35.13583333333333,
      lng: 126.82583333333334,
      wl: '0.00',
      fl: '0',
      홍수주의보: 7.5,
      홍수경보: 8.5,
  ...
  function addWaterLevelMarkers() {
    observatories.forEach(function (obs) {
      ...
      marker.addListener('click', function () {
        const waterlevelcontent = `<div style="color: black;">
